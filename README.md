...
- **Live Demo**: [https://harshdhane-medibook.hf.space/](https://harshdhane-medibook.hf.space/) (Hosted on Hugging Face Spaces; test mode for payments.)
- **Google Drive Folder** (Source ZIP, Docs, Video): [https://drive.google.com/drive/folders/1-TMUSCgfvPPoxj5VphTvZye_3irqmSpF?usp=sharing](https://drive.google.com/drive/folders/1-TMUSCgfvPPoxj5VphTvZye_3irqmSpF?usp=sharing)
- **Developer Portfolio**: [https://harshdhane-techfolio.hf.space/](https://harshdhane-techfolio.hf.space/)
- **Related Projects**:
  - [AI-Based Medicine Price Comparison](https://harshdhane-mpcw.hf.space/)
  - [AI-Based Student Attendance Management System](https://harshdhane-studentattendancesystemusingfacialrecognition.hf.space/)
...
1. **Clone the Repository**:
   ```
   git clone https://github.com/harshdhane25/AI-Powered-Patient-Bed-Booking-Hospital-Resource-Management-Ecosystem.git
...
## 🚀 Usage
1. **Patient Flow**: Register → Dashboard → Select Hospital → Book Bed/Appointment/Ambulance → Pay → Receive Email Bill.
2. **Admin Flow**: Login → Manage Resources (Add Doctors/Rooms) → Approve Bookings.
3. **AI Chat**: Navigate to `/patient/ai_chat` → Ask "Show hospitals" for guided assistance.
4. **Demo Video**: Watch the 3:45 min walkthrough in the [Google Drive folder](https://drive.google.com/drive/folders/1-TMUSCgfvPPoxj5VphTvZye_3irqmSpF?usp=sharing).
